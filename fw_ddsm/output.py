...
class Output:
    ...
    def save_to_output_folder(self, algorithm,
        ...
        overview_dict[k0_par] = df_others[k0_par].values[-1]
        overview_dict[k0_demand_max] = df_others[k0_demand_max].values[-1]
        overview_dict[k0_demand_reduction] = df_others[k0_demand_reduction].values[-1]
