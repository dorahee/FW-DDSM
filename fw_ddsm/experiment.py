...
class Experiment:
    ...
    def new_data(self, file_task_power=file_demand_list, max_demand_multiplier=maxium_demand_multiplier,
                 file_normalised_pricing_table=file_pricing_table, file_preferred_demand_profile=file_probability,
        ...
        self.community.new(num_households=self.num_households,
                           file_probability_path=file_preferred_demand_profile,
    ...
    def iteration(self, algorithm):
        ...
        while step > 0:
            ...
            # aggregator, k > 0
            aggregate_demand_profile_fw, step, prices, total_consumption_cost_fw, total_inconvenience_fw, time_fw \
